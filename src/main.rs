use kasane_logic::{RangeId, SingleId, spatial_id::collection::set::memory::SetOnMemory};
...
fn main() {
    ...
    let mut set2 = SetOnMemory::default();
    set2.insert(&diff);

    let set3 = set.intersection(&set2);

    for ele in set3.range_ids() {
        println!("{},", ele);
    }
}
...
// use kasane_logic::spatial_id::collection::set::memory::SetOnMemory;

// fn main() {
//     let set = SetOnMemory::default();
// }
