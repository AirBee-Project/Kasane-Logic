...
const MAX_ZOOM_LEVEL_CONST: usize = 30;

const XY_MAX_ARRAY: [u32; MAX_ZOOM_LEVEL_CONST + 1] = [
...
const F_MIN_ARRAY: [i32; MAX_ZOOM_LEVEL_CONST + 1] = [
    -1,
    -2,
    -4,
    -8,
...
const F_MAX_ARRAY: [i32; MAX_ZOOM_LEVEL_CONST + 1] = [
    0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535, 131071,
    262143, 524287, 1048575, 2097151, 4194303, 8388607, 16777215, 33554431, 67108863, 134217727,
    268435455, 536870911, 1073741823,
];
...
impl ZoomLevel {
    ...
    /// 扱える最大のズームレベル。
    pub const MAX: ZoomLevel = ZoomLevel(MAX_ZOOM_LEVEL_CONST as u8);
    ...
    pub const fn new(z: u8) -> Result<Self, Error> {
        if z > MAX_ZOOM_LEVEL_CONST as u8 {
