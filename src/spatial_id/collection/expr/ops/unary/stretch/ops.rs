    ...
    C::Value: 'static,
{
    ...
    pub fn stretch_f_with(self, z: u8, index: i32, conflict: ConflictPolicy<C::Value>) -> Self {
        Query::Unary(
            crate::spatial_id::collection::expr::ops::unary::UnaryOp::Stretch(StretchParam::f(
                z, index, conflict,
            )),
    ...
    pub fn stretch_x_with(self, z: u8, index: i32, conflict: ConflictPolicy<C::Value>) -> Self {
        Query::Unary(
            crate::spatial_id::collection::expr::ops::unary::UnaryOp::Stretch(StretchParam::x(
                z, index, conflict,
            )),
            alloc::boxed::Box::new(self),
        )
    ...
    pub fn stretch_y_with(self, z: u8, index: i32, conflict: ConflictPolicy<C::Value>) -> Self {
        Query::Unary(
            crate::spatial_id::collection::expr::ops::unary::UnaryOp::Stretch(StretchParam::y(
                z, index, conflict,
            )),
            alloc::boxed::Box::new(self),
        )
