    ...
    C::Value: 'static,
{
    ...
    pub fn level_f_with(self, z: u8, lo: i32, hi: i32, conflict: ConflictPolicy<C::Value>) -> Self {
        Query::Unary(
            crate::spatial_id::collection::expr::ops::unary::UnaryOp::Level(LevelParam::f(
                z, lo, hi, conflict,
            )),
    ...
    pub fn level_x_with(self, z: u8, lo: u32, hi: u32, conflict: ConflictPolicy<C::Value>) -> Self {
        Query::Unary(
            crate::spatial_id::collection::expr::ops::unary::UnaryOp::Level(LevelParam::x(
                z, lo, hi, conflict,
            )),
            alloc::boxed::Box::new(self),
        )
    ...
    pub fn level_y_with(self, z: u8, lo: u32, hi: u32, conflict: ConflictPolicy<C::Value>) -> Self {
        Query::Unary(
            crate::spatial_id::collection::expr::ops::unary::UnaryOp::Level(LevelParam::y(
                z, lo, hi, conflict,
            )),
            alloc::boxed::Box::new(self),
        )
