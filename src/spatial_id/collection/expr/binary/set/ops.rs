    ...
    C::Value: 'static,
{
    pub fn union_with(
        ...
        Query::Binary(
            crate::spatial_id::collection::expr::query::BinaryOp::Union(conflict),
    ...
    pub fn intersection_with(
        ...
        Query::Binary(
            crate::spatial_id::collection::expr::query::BinaryOp::Intersection(conflict),
            alloc::boxed::Box::new(self),
            alloc::boxed::Box::new(other.into()),
        )
    }
    ...
    pub fn difference(self, other: impl Into<Query<C>>) -> Self {
        Query::Binary(
            crate::spatial_id::collection::expr::query::BinaryOp::Difference,
            alloc::boxed::Box::new(self),
            alloc::boxed::Box::new(other.into()),
        )
    }
    ...
    pub fn symmetric_difference(self, other: impl Into<Query<C>>) -> Self {
        Query::Binary(
            crate::spatial_id::collection::expr::query::BinaryOp::SymmetricDifference,
            alloc::boxed::Box::new(self),
            alloc::boxed::Box::new(other.into()),
        )
    }
    ...
    pub fn mask(self, other: impl Into<Query<C>>) -> Self {
        Query::Binary(
            crate::spatial_id::collection::expr::query::BinaryOp::Mask,
            alloc::boxed::Box::new(self),
            alloc::boxed::Box::new(other.into()),
        )
    }
