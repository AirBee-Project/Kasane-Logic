use crate::spatial_id::collection::query::ops::unary::kernel::UnaryKernel;
use crate::spatial_id::collection::query::ops::unary::level::{Level, LevelParam};
use crate::spatial_id::collection::query::ops::unary::shift::{Shift, ShiftParam};
use crate::spatial_id::collection::query::ops::unary::spread::{Spread, SpreadParam};
use crate::spatial_id::collection::query::ops::unary::stretch::{Stretch, StretchParam};
...
impl<C: SpatialIdCollection> UnaryOp<C> {
    ...
    pub fn is_identity(&self) -> bool {
        use crate::spatial_id::collection::query::ops::unary::fill::FillDefault;
    ...
    pub fn run(self, input: C) -> Result<C, Error> {
        match self {
            ...
            UnaryOp::Fill(v) => {
                crate::spatial_id::collection::query::ops::unary::fill::FillDefault::execution::<C, C>(
                    input, v,
                )
            }
