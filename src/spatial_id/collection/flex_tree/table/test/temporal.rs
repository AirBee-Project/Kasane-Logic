...
//! [`SpatioTemporalTable`](crate::spatial_id::collection::spatio_temporal::SpatioTemporalTable)
//! と突き合わせる。
...
fn table_get_atom_oracle() {
    ...
    let query =
        FlexId::new_with_temporal(1u8, 0, 1u8, 0, 1u8, 0, TemporalId::new(60, 1).unwrap()).unwrap();
